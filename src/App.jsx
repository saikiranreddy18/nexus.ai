...
import QuizPortal from './components/ui/QuizPortal'
  ...
  return (
    <div className="relative min-h-screen">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
          ...
          <nav className="hidden items-center gap-6 text-sm text-slate-300 md:flex">
            ...
            <a
              ...
              className="rounded-full border border-exus-purple/60 px-4 py-1.5 font-display text-cyan-300 transition-colors hover:bg-exus-purple/20 hover:text-white"
            >
              Join waitlist
            </a>
          </nav>
      ...
      <div
        id="tool-tooltip"
        aria-hidden="true"
        className="glass pointer-events-none fixed z-[85] -translate-x-1/2 -translate-y-full whitespace-nowrap rounded-full px-4 py-1.5 font-display text-xs font-semibold tracking-wide text-white"
      ...
      <div className="fixed bottom-6 left-6 z-[76] flex items-center gap-2">
        <button
          ...
          className="glass flex h-11 w-11 items-center justify-center rounded-full text-slate-300 transition-colors hover:text-white"
        >
        ...
        <button
          ...
          className="glass rounded-full px-5 py-2.5 font-display text-xs font-medium uppercase tracking-[0.2em] text-cyan-300 transition-colors hover:text-white"
        >
      ...
      <AnimatePresence>
        {quizOpen && <QuizPortal onClose={() => setQuizOpen(false)} />}
      </AnimatePresence>
    </div>
  )
}
