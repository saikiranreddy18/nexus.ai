...
export default function Learning() {
  ...
  // A week unlocks once the previous week is fully complete.
    ...
    <div className="mx-auto max-w-2xl px-5 py-6 lg:py-10">
        ...
        {milestones.map((m, mi) => {
          ...
          return (
            ...
            >
              ...
              <div className={`sticker p-5 ${locked ? 'opacity-50' : ''}`} style={{ transform: 'rotate(0)' }}>
      ...
      {pct === 100 && (
        <motion.div
          ...
          className="sticker mt-2 p-5 text-center"
